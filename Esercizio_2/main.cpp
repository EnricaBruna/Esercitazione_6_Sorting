...
int main(int argc, char ** argv)
{
    ...
    for (int i = 1; i< argc; i++ )
    {
        ...
        double durationMerge = std::chrono::duration_cast<std::chrono::microseconds>(t_e_Merge-t_b_Merge).count(); //misura una differenza di tempo
        ...
        double durationBubble = std::chrono::duration_cast<std::chrono::microseconds>(t_e_Bubble-t_b_Bubble).count(); //misura una differenza di tempo
